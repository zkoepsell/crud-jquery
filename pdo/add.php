<?php
require_once "pdo.php"; // making the database connection and leave it in the variable $pdo 
...
if (isset($_POST['first_name']) && isset($_POST['last_name']) && isset($_POST['email']) && isset($_POST['headline']) && isset($_POST['summary'])) {
    ...
    // validate postition entries if present
    $msg = validatePos();
    if (is_string($msg)) {
        $_SESSION['error'] = $msg;
        header("Location: add.php");
...
<body>
    <div class="container">
        ...
        <form method="POST">
            <p>First Name:
                <input type="text" name="first_name" value="" size="60">
            </p>
            <p>Last Name:
                <input type="text" name="last_name" value="" size="60">
            </p>
            <p>Email:
                <input type="text" name="email" value="" size="30">
            </p>
            <p>Headline:
                <input type="year" name="headline" value="" size="80">
            </p>
            <p>Summary:
                <input type="text" name="summary" value="" rows="8" cols="80">
            </p>
            <p>Position:
                <input type="submit" id="addPos" value="+">
            <div id="position_fields"></div>
            </p>
            <p>School: <input type="text" size="80" name="edu_school" class="school" value="" > </p>
